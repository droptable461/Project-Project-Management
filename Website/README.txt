...
To run the server: shows webpage
...
In the my projects page (adding a project): 
	...
	-the my projects page should display three columns: "to do," "doing," and "done" 
	-To add a project, simply click the "Add Project" button
